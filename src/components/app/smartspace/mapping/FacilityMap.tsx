...
import EditAccessPointModal from "@views/smartspace/mapping/EditAccessPointModal";
import EditWallModal from "@views/smartspace/mapping/EditWallModal";
            ...
            {(() => {
              ...
              const treeLines = Object.entries(predecessor).map(
                ([childStr, parent]) => {
                  ...
                  const parentIdx = parent as number;
                  const p1 = locks[parentIdx];
