...
import AddAuthentication from "@views/authentication-settings/AddAuthentication";
import PaginationFooter from "@components/shared/PaginationFooter";
import RenameAuthentication from "@views/authentication-settings/RenameAuthentication";
  ...
  return (
    <div className="dark:text-white dark:bg-zinc-900 h-screen w-screen flex flex-col overflow-hidden font-roboto">
      ...
      {user && permissions.authenticationPlatform ? (
        <div>
          {/* Navbar */}
          <Navbar setDashboardMenu={null} dashboardMenu={null} darkMode={darkMode} toggleDarkMode={toggleDarkMode} />
          {/* Body */}
