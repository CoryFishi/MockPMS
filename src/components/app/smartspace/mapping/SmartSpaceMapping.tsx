...
import FacilityMap from "@views/smartspace/mapping/FacilityMap";
import Sidebar from "@views/smartspace/mapping/Sidebar";
import { applyChange } from "@views/smartspace/mapping/applyChange";
import EditUnitModal from "@views/smartspace/mapping/EditUnitModal";
...
function SmartSpaceMapping() {
  ...
  return (
    <div className="flex h-full relative">
      ...
      <div
        className={`p-2 h-[${layout.canvasSize.height}px] w-[${layout.canvasSize.width}px]`}
      >
        <FacilityMap
          layout={layout}
          params={params}
